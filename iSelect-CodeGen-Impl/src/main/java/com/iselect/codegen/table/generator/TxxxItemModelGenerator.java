 ...
 * @author Hiep
 */
public class TxxxItemModelGenerator extends CGCodeGeneratorAbs<ClassComponentImpl, CGPropertyComponentAbs>{

    public TxxxItemModelGenerator(String template, String baseDir, String subDir) {
    ...
    public void generateCode(ClassComponentImpl t) {
        ...
        try {
            ...
            FileUtil.writeFile(path, t.getName()+"ItemModel.java", sb.toString());
